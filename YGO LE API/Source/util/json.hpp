...
namespace json {
    ...
    public:
        union BackingData {
            ...
            deque<JSON>* List;
            unordered_map<string, JSON>* unordered_map;
            string* String;
            double              Float;
            long long           Int;
            bool                Bool;
        ...
        JSON(JSON&& other)
            ...
            , Type(other.Type)
        {
            other.Type = Class::Null; other.Internal.unordered_map = nullptr;
        }
        ...
        JSON& operator=(JSON&& other) {
            ...
            Internal = other.Internal;
            Type = other.Type;
            other.Internal.unordered_map = nullptr;
        ...
        JSON(const JSON& other) {
            ...
            case Class::Object:
                Internal.unordered_map =
                    new unordered_map<string, JSON>(other.Internal.unordered_map->begin(),
                        other.Internal.unordered_map->end());
                break;
            case Class::Array:
                Internal.List =
        ...
        JSON& operator[](const string& key) {
            SetType(Class::Object); return Internal.unordered_map->operator[](key);
        }
        ...
        const JSON& at(const string& key) const {
            return Internal.unordered_map->at(key);
        }
        ...
        __declspec(noinline) bool hasKey(const string& key) const {
            if (Type == Class::Object)
                return Internal.unordered_map->find(key) != Internal.unordered_map->end();
            return false;
        }

        long long size() const {
            if (Type == Class::Object)
                return Internal.unordered_map->size();
        ...
        JSONWrapper<unordered_map<string, JSON>> ObjectRange() {
            if (Type == Class::Object)
                return JSONWrapper<unordered_map<string, JSON>>(Internal.unordered_map);
        ...
        JSONConstWrapper<unordered_map<string, JSON>> ObjectRange() const {
            if (Type == Class::Object)
                return JSONConstWrapper<unordered_map<string, JSON>>(Internal.unordered_map);
        ...
        string dump(int depth = 1, string tab = "  ") const {
            ...
            case Class::Object: {
                string s = "{\n";
                bool skip = true;
                for (auto& p : *Internal.unordered_map) {
                    if (!skip) s += ",\n";
    ...
    private:
        void SetType(Class type) {
            ...
            switch (type) {
            case Class::Null:      Internal.unordered_map = nullptr;                break;
            case Class::Object:    Internal.unordered_map = new unordered_map<string, JSON>(); break;
    ...
    private:
        ...
        */
        void ClearInternal() {
            switch (Type) {
            case Class::Object: delete Internal.unordered_map;    break;
